# Graph Report - saude-orquestrator-llm  (2026-08-25)

## Corpus Check
- 24 files · ~6,264 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 145 nodes · 200 edges · 25 communities (16 shown, 9 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `62a1c95c`
...
## Knowledge Gaps
- **18 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `init_redis.sh script`, `pull_ollama_model.sh script`, `teste.sh script` (+13 more)
