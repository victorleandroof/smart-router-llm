...
## Corpus Check
- 24 files · ~6,220 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 145 nodes · 199 edges · 25 communities (15 shown, 10 thin omitted)
...
Cohesion: 0.20
Nodes (15): fix_message_ordering(), _flatten_content(), _generate_valid_id(), _has_tool_block(), _is_mistral_model(), _is_ollama_model(), normalize_assistant_content(), normalize_content_for_ollama() (+7 more)
